...
def add_dev_data_id(message):
    ...
    # print "add_dev_data_id(%s, %s)" % (dev_data_index, application_id)
...
def add_dev_field_description(message):
    ...
    # print "add_dev_field_description(%s, %s, %s, %s, %s, %s)" % (dev_data_index, field_def_num, BASE_TYPES[base_type_id].name, field_name, units, native_field_num) 
